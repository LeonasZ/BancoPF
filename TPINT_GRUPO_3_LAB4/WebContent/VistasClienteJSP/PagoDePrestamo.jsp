...
<nav class="navbar bg-body-tertiary fixed-top">
  <div class="container-fluid">
    ...
    <div class="container" style="margin-top: 100px;">
        <h2 class="text-center mb-4">Pagar Préstamo</h2>
        <form action="procesar_pago.jsp" method="POST">
           
           
            <div class="mb-3">
                <label for="cuenta-origen-prestamo" class="form-label">Número de Préstamo:</label>
                <select class="form-control" id="cuenta-origen-prestamo" name="cuenta_origen_prestamo" required style="width: 279px; height: 35px; ">
                    <option value="">Seleccione el préstamo a pagar</option>
                    <!-- Añade más opciones de préstamos según sea necesario -->
 
                </select>
            </div>
            <div class="mb-3">
                <label for="fecha-pago" class="form-label">Fecha de Pago:</label>
                <input type="date" class="form-control" id="fecha-pago" name="fecha_pago" required style="width: 251px; ">
            </div>
            <div class="mb-3">
                <label for="cuotas" class="form-label">Cantidad de Cuotas a Pagar:</label>
            ...
            <div class="form-group">
                <label for="monto-pago" class="form-label">Monto a Pagar:</label>
                                <input type="text" id="concepto" name="concepto" style="width: 248px; ">
            
            </div>
            <div class="mb-3">
                <label for="cuenta-origen" class="form-label">Cuenta de Origen:</label>
                <select class="form-control" id="cuenta-origen" name="cuenta_origen" required style="width: 231px; height: 35px; ">
                    <option value="">Seleccione una cuenta</option>
                    <!-- Añade más opciones de cuentas según sea necesario -->
                </select>
            </div>
            <div class="form-group">
                <button type="submit" style="width: 368px; height: 48px; ">Pagar Prestamo</button>
            </div>
        </form>
    </div>
