...
<form class="row g-5" >	
    <div class="col-md-6">
      <label for="inputIdUsuario" class="form-label"><b>Id Usuario</b></label>
      <input type="text" class="form-control form-control-sm" id="inputIdUsuario" value="<%=user.getIdUsuario() %>" readonly>
    </div>
    <div class="col-md-6">
      <label for="inputNombreUsuario" class="form-label"><b>Usuario</b></label>
      <input type="text" class="form-control form-control-sm" id="inputUsuario" value="<%=user.getUsuario() %>" readonly>
    </div>
    <div class="col-md-6">
      <label for="inputTipo" class="form-label"><b>Tipo Usuario</b></label>
      <input type="text" class="form-control form-control-sm" id="inputTipo" value="<%=user.getTipoUsuario() %>" readonly>
    </div>
    
    <div class="col-md-6">
      <label for="inputestado" class="form-label"><b>Estado</b></label>
      <input type="text" class="form-control form-control-sm" id="inputestado" value="<% if(user.isEstado()){%>Activo<%} else{%>Inactivo<%} %>" readonly>
    </div>
