...
<!-- Boton volver -->
  ...
  <form class="row g-6" >	
    <div class="col-md-6">
      ...
      <input type="text" class="form-control form-control-sm" id="inputDni">
    </div>
    <div class="col-md-6">
      <label for="inputCuil" class="form-label">CUIL</label>
      <input type="text" class="form-control form-control-sm" id="inputCuil">
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
      ...
      <input type="text" class="form-control form-control-sm" id="inputNacionalidad">
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
      ...
      <input type="text" class="form-control form-control-sm" id="inputLocalidad">
    </div>
    <div class="col-md-6">
      <label for="inputFechaNacimiento" class="form-label">Fecha de Nacimiento</label>
      <input type="text" class="form-control form-control-sm" id="inputFechaNacimiento">
    </div>
    <div class="col-md-6">
      <label for="inputGenero" class="form-label">Género</label>
      <input type="text" class="form-control form-control-sm" id="inputGenero">
    </div>
    <div class="col-md-6">
      <label for="inputCorreoElectronico" class="form-label">Correo Electrónico</label>
      <input type="text" class="form-control form-control-sm" id="inputCorreoElectronico">
    </div>
    <div class="col-md-6">
      <label for="inputNombreUsuario" class="form-label">Usuario</label>
      <input type="text" class="form-control form-control-sm" id="inputUsuario" readonly>
    </div>
    <div class="col-md-6">
      <label for="inputContrasena" class="form-label">Contraseña</label>
      <input type="text" class="form-control form-control-sm" id="inputContrasena">
    </div>
    <div class="col-md-12">
      <div class="form-check">
        <input class="form-check-input" type="checkbox" id="gridCheck">
        <label class="form-check-label" for="gridCheck"> Administrador Activo/Inactivo </label>
      </div>
    </div>
