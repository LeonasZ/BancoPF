...
<table class="table table-responsive">
  ...
  <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#detalleModal">Detalle</button>
  ...
  <button type="button" class="btn btn-danger">Rechazar</button>
  	...
  	<!-- Modal con detalles del prestamo  -->
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="detalleModalLabel">Detalle Préstamo</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
<form  class="row g-3" >
<div class="col-md-2">
    <label for="inputIDPrestamo" class="form-label">Id Préstamo</label>
    <input type="text" class="form-control" id="inputIDPrestamo" readonly>
  </div>
  <div class="col-md-2">
    <label for="inputIDCuenta" class="form-label">ID Cuenta</label>
    <input type="text" class="form-control" id="inputIDCuenta" readonly>
  </div>
    <div class="col-md-4">
    <label for="inputNombreCliente" class="form-label">Nombre</label>
    <input type="text" class="form-control" id="inputNombreCliente" readonly>
  </div>
  <div class="col-md-4">
    <label for="inputApellidoCliente" class="form-label">Apellido</label>
    <input type="text" class="form-control" id="inputApellidoCliente" readonly>
  </div>
  <div class="col-md-4">
  ...
  <div class="col-md-8">
    <label for="inputCbu" class="form-label">CBU a depositar</label>
    <input type="text" class="form-control" id="inputCbu" readonly>
  </div>
  <div class="col-md-2">
    <label for="inputFechaSolicitado" class="form-label">Fecha Solicitado</label>
    <input type="text" class="form-control" id="inputFechaSolicitado" readonly>
  </div>
  <div class="col-md-5">
    <label for="inputTotalConIntereses" class="form-label">Importe con Intereses</label>
    <input type="text" class="form-control" id="inputTotalConIntereses" readonly>
  </div>
  <div class="col-5">
    <label for="inputImporteSolicitado" class="form-label">Importe Solicitado por el Cliente</label>
    <input type="text" class="form-control" id="inputImporteSolicitado" readonly>
  </div>
  
  <div class="col-3">
    <label for="inputTotalCuotas" class="form-label">Total de Cuotas</label>
    <input type="text" class="form-control" id="inputTotalCuotas" readonly>
  </div>
  <div class="col-6">
    <label for="inputImporteMensual" class="form-label">Monto a pagar por Mes</label>
    <input type="text" class="form-control" id="inputImporteMensual" readonly>
  </div>
